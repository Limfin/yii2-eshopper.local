			...
			<div class="col-sm-9 padding-right">
				<div class="features_items">
					...
					<?php if (!empty($products)) : ?>
						<!-- чтобы спец символы введеные пользователь в строку поиска не обрабатывались используется метод Html::encode() -->
					...
					<?php else : ?>
						<!-- чтобы спец символы введеные пользователь в строку поиска не обрабатывались используется метод Html::encode() -->
						<h2 class="title text-center">По вашему запросу: "<i><?= Html::encode($q) ?></i>", ничего не найдено</h2>
					<?php endif; ?>
					<div class="clearfix"></div>
				</div>
				<!--features_items-->
